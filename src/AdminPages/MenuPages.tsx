    ...
    return (
        <>
            <div className='w-full bg-black text-white h-screen py-10'>
                ...
                <div className='flex px-60 text-black w-full overflow-hidden py-3'>
                    <div className='flex bg-gray-800 w-full rounded-lg p-2'>
                        ...
                        {/* </div> */}
                        <div className='py-3 font-semibold px-3 w-full overflow-hidden'>
                            <h1 className='text-gray-700'>Pradip</h1>
                            <button onClick={() => UpdateMenuModelShow()} className='btn bg-orange-400 text-black font-semibold rounded-lg px-4 py-1.5 float-right'>Edit</button>
                            <p className='text-gray-600'>
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nisi
                                Lorem ipsum
                            </p>
                            <h1 className='text-white'>Price: <span className='text-orange-400'>₹145</span> </h1>
                        </div>
                    </div>
                </div>
                <div className='flex px-60 text-black w-full overflow-hidden py-3'>
                    <div className='flex bg-gray-800 w-full rounded-lg p-2'>
                        ...
                        <div className='py-3 font-semibold px-3 w-full overflow-hidden'>
                            <h1 className='text-gray-700'>Pradip</h1>
                            <button onClick={() => setshowmodel()} className='btn bg-orange-400 text-black font-semibold rounded-lg px-4 py-1.5 float-right'>Edit</button>
                            <p className='text-gray-600'>
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nisi
                                Lorem ipsum
                            </p>
