      ...
      <div className='p-6 bg-black text-white shadow-md h-screen'>
        ...
        <div className='flex justify-center w-full z-50 bg-black relative'>
          {showupdate && (
            ...
            //   <div className="mt-6 p-6 bg- rounded shadow-lg absolute z-50 w-[500px] ">
            ...
            <div className="z-50 bg-black/85 flex items-center justify-center px-4 relative">
              <div className="mt-6 p-6 bg-black rounded-lg shadow-2xl w-full max-w-lg">
                <RxCross2
                  className="absolute top-4 right-4 text-white text-2xl cursor-pointer hover:text-orange-500 transition duration-300"
